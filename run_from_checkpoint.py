"""
Notes:
Assuming chekpoint is saved in the same directory where new checkpoints will be saved 
(e.g. as a default will be Results/<map_name>/Checkpoints/<PID>_<step_idx> )
"""
...
def main():
    ...
    HPs = dict(action_space=action_space, n_steps=args.n_steps, H=args.H, 
