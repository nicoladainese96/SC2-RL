...
from RelationalModule.AC_networks import OheParamActor, OheCritic #custom module
...
class MoveToBeaconParamA2C():
    ...
    * Possible to use twin networks for the critic and the critic target for improved 
    ...
    def __init__(self, action_space, map_size, env, lr, gamma, TD=True, twin=True, tau = 0.3, 
        ...
        **net_args: dict (optional)
        ...
        self.actor = OheParamActor(action_space, map_size, env, **net_args)
